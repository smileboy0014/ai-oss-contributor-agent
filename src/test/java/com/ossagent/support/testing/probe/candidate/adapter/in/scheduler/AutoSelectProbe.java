 ...
 * <h2>왜 미끼가 필요한가</h2>
 *
 * <p>지금 이 저장소에는 {@code adapter/in/scheduler} 패키지가 <b>하나도 없다.</b>
 * 그래서 그 규칙은 <b>0건을 검사하고 초록</b>이 된다 — 규칙이 통째로 잘못 쓰여 있어도
 * 아무도 모른다. 정작 그 규칙이 필요해지는 시점은 <b>누군가 스케줄러를 처음 만드는 때</b>이고,
 * 그때 규칙이 고장 나 있으면 S-6 이 조용히 뚫린다.
 *
