...
public class AnalyzeRepositoryPolicyUseCase {
     ...
     *
     * <h2>🔴 이것은 게이트가 아니다</h2>
     * {@code assertContributionAllowed} 와 <b>거부 조건이 다른 것이 정상</b>이다.
     *
     * <table>
     ...
     * 불가능하다」가 성립하지 않는다.
     *
     * <p>판정 필드({@code aiContributionAllowed}·{@code pendingReason})를 값에 싣지 않는 이유도
     * 같다 — {@link ContributionConstraints} javadoc.
     *
